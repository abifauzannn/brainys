<div>
    <section class="px-5 py-20 xl:py-[120px]f" id="action-section">
        <div class="container text-center">
            <h2>Partnership kami</h2>
            <p>Sistem kami didukung oleh beberapa mitra dan instansi</p>

            <div class="flex flex-row items-center justify-center space-x-20" data-aos="fade-up" data-aos-duration="1000"
